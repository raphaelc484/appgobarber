...
import {
  ...
  Hour,
  HourText,
  CreateAppointmentmentButton,
  CreateAppointmentmentButtonText,
} from './styles';
      ...
      <Content>
        ...
        <Schedule>
          ...
          <Section>
            ...
            <SectionContent>
              {morningAvailabilty.map(({ hourFormatted, hour, available }) => (
                <Hour
                  enabled={available}
        ...
        <CreateAppointmentmentButton onPress={handleCreateAppointment}>
          <CreateAppointmentmentButtonText>
            Agendar
          </CreateAppointmentmentButtonText>
        </CreateAppointmentmentButton>
